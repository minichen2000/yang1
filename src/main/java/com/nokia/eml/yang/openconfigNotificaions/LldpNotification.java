/* 
 * @(#)LldpNotification.java        1.0 15/06/18
 *
...
import com.nokia.eml.yang.openconfigNotificaions.lldpNotification.Update;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/lldp-notification"
 * <p>
 * See line 94 in
 ...
 */
public class LldpNotification extends YangElement {
    ...
    /**
     * Constructor for an empty LldpNotification object.
     */
    public LldpNotification() {
        super(OcNotify.NAMESPACE, "lldp-notification");
        setDefaultPrefix();
     ...
     */
    public LldpNotification clone() {
        return (LldpNotification)cloneContent(new LldpNotification());
    }
     ...
     */
    public LldpNotification cloneShallow() {
        return (LldpNotification)cloneShallowContent(new LldpNotification());
    }
