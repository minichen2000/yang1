...
import com.nokia.eml.yang.openconfigNotificaions.alarmNotification.update.system.sshServer.Config;
import com.nokia.eml.yang.openconfigNotificaions.alarmNotification.update.system.sshServer.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/alarmNotification/update/system/ssh-server"
 * <p>
 * See line 159 in
 ...
 */
public class SshServer extends YangElement {
    ...
    /**
     * Constructor for an empty SshServer object.
     */
    public SshServer() {
        super(OcSysTerm.NAMESPACE, "ssh-server");
        setDefaultPrefix();
    ...
    public SshServer clone() {
        return (SshServer)cloneContent(new SshServer());
    }
     ...
     */
    public SshServer cloneShallow() {
        return (SshServer)cloneShallowContent(new SshServer());
    }
