...
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.backplane.Config;
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.backplane.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/platformNotification/update/components/component/backplane"
 * <p>
 * See line 629 in
 ...
 */
public class Backplane extends YangElement {
    ...
    /**
     * Constructor for an empty Backplane object.
     */
    public Backplane() {
        super(OcPlatform.NAMESPACE, "backplane");
    }
     ...
     */
    public Backplane clone() {
        return (Backplane)cloneContent(new Backplane());
    }
     ...
     */
    public Backplane cloneShallow() {
        return (Backplane)cloneShallowContent(new Backplane());
    }
