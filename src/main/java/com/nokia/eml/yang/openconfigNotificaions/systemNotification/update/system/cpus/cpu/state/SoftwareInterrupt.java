/* 
 * @(#)SoftwareInterrupt.java        1.0 15/06/18
 *
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/systemNotification/update/system/cpus/cpu/state/software-interrupt"
 * <p>
 * See line 901 in
 ...
 */
public class SoftwareInterrupt extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty SoftwareInterrupt object.
     */
    public SoftwareInterrupt() {
        super(OcSys.NAMESPACE, "software-interrupt");
    }
     ...
     */
    public SoftwareInterrupt clone() {
        return (SoftwareInterrupt)cloneContent(new SoftwareInterrupt());
    }
     ...
     */
    public SoftwareInterrupt cloneShallow() {
        return (SoftwareInterrupt)cloneShallowContent(new SoftwareInterrupt());
    }
