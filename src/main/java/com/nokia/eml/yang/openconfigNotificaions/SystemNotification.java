/* 
 * @(#)SystemNotification.java        1.0 15/06/18
 *
...
import com.nokia.eml.yang.openconfigNotificaions.systemNotification.Update;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/system-notification"
 * <p>
 * See line 66 in
 ...
 */
public class SystemNotification extends YangElement {
    ...
    /**
     * Constructor for an empty SystemNotification object.
     */
    public SystemNotification() {
        super(OcNotify.NAMESPACE, "system-notification");
        setDefaultPrefix();
    ...
    public SystemNotification clone() {
        return (SystemNotification)cloneContent(new SystemNotification());
    }
     ...
     */
    public SystemNotification cloneShallow() {
        return (SystemNotification)cloneShallowContent(new SystemNotification());
    }
