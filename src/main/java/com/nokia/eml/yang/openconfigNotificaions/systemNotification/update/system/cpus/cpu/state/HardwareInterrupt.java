/* 
 * @(#)HardwareInterrupt.java        1.0 15/06/18
 *
...
package com.nokia.eml.yang.openconfigNotificaions.systemNotification.update.system.cpus.cpu.state;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/systemNotification/update/system/cpus/cpu/state/hardware-interrupt"
 * <p>
 * See line 894 in
 ...
 */
public class HardwareInterrupt extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty HardwareInterrupt object.
     */
    public HardwareInterrupt() {
        super(OcSys.NAMESPACE, "hardware-interrupt");
    }
     ...
     */
    public HardwareInterrupt clone() {
        return (HardwareInterrupt)cloneContent(new HardwareInterrupt());
    }
     ...
     */
    public HardwareInterrupt cloneShallow() {
        return (HardwareInterrupt)cloneShallowContent(new HardwareInterrupt());
    }
