 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/systemNotification/update/system/cpus/cpu/state/kernel"
 * <p>
 * See line 865 in
 ...
 */
public class Kernel extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Kernel object.
     */
    public Kernel() {
        super(OcSys.NAMESPACE, "kernel");
    }
     ...
     */
    public Kernel clone() {
        return (Kernel)cloneContent(new Kernel());
    }
     ...
     */
    public Kernel cloneShallow() {
        return (Kernel)cloneShallowContent(new Kernel());
    }
