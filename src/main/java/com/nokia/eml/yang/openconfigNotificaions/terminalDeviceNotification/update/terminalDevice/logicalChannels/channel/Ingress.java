...
import com.nokia.eml.yang.openconfigNotificaions.terminalDeviceNotification.update.terminalDevice.logicalChannels.channel.ingress.Config;
import com.nokia.eml.yang.openconfigNotificaions.terminalDeviceNotification.update.terminalDevice.logicalChannels.channel.ingress.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/terminalDeviceNotification/update/terminalDevice/logicalChannels/channel/ingress"
 * <p>
 * See line 642 in
 ...
 */
public class Ingress extends YangElement {
    ...
    /**
     * Constructor for an empty Ingress object.
     */
    public Ingress() {
        super(OcOptTerm.NAMESPACE, "ingress");
    }
    ...
    public Ingress clone() {
        return (Ingress)cloneContent(new Ingress());
    }
     ...
     */
    public Ingress cloneShallow() {
        return (Ingress)cloneShallowContent(new Ingress());
    }
