/* 
 * @(#)IntegratedCircuit.java        1.0 15/06/18
 *
...
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.integratedCircuit.Config;
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.integratedCircuit.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/platformNotification/update/components/component/integrated-circuit"
 * <p>
 * See line 613 in
 ...
 */
public class IntegratedCircuit extends YangElement {
    ...
    /**
     * Constructor for an empty IntegratedCircuit object.
     */
    public IntegratedCircuit() {
        super(OcPlatform.NAMESPACE, "integrated-circuit");
    }
     ...
     */
    public IntegratedCircuit clone() {
        return (IntegratedCircuit)cloneContent(new IntegratedCircuit());
    }
     ...
     */
    public IntegratedCircuit cloneShallow() {
        return (IntegratedCircuit)cloneShallowContent(new IntegratedCircuit());
    }
