...
import com.nokia.eml.yang.openconfigNotificaions.alarmNotification.update.system.clock.Config;
import com.nokia.eml.yang.openconfigNotificaions.alarmNotification.update.system.clock.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/alarmNotification/update/system/clock"
 * <p>
 * See line 151 in
 ...
 */
public class Clock extends YangElement {
    ...
    /**
     * Constructor for an empty Clock object.
     */
    public Clock() {
        super(OcSys.NAMESPACE, "clock");
    }
     ...
     */
    public Clock clone() {
        return (Clock)cloneContent(new Clock());
    }
    ...
    public Clock cloneShallow() {
        return (Clock)cloneShallowContent(new Clock());
    }
