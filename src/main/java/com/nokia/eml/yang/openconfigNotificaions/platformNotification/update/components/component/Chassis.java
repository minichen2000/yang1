...
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.chassis.Config;
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.chassis.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/platformNotification/update/components/component/chassis"
 * <p>
 * See line 459 in
 ...
 */
public class Chassis extends YangElement {
    ...
    /**
     * Constructor for an empty Chassis object.
     */
    public Chassis() {
        super(OcPlatform.NAMESPACE, "chassis");
    }
    ...
    public Chassis clone() {
        return (Chassis)cloneContent(new Chassis());
    }
     ...
     */
    public Chassis cloneShallow() {
        return (Chassis)cloneShallowContent(new Chassis());
    }
