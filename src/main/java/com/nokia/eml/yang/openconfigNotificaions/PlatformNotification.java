/* 
 * @(#)PlatformNotification.java        1.0 15/06/18
 *
...
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.Update;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/platform-notification"
 * <p>
 * See line 59 in
 ...
 */
public class PlatformNotification extends YangElement {
    ...
    /**
     * Constructor for an empty PlatformNotification object.
     */
    public PlatformNotification() {
        super(OcNotify.NAMESPACE, "platform-notification");
        setDefaultPrefix();
     ...
     */
    public PlatformNotification clone() {
        return (PlatformNotification)cloneContent(new PlatformNotification());
    }
     ...
     */
    public PlatformNotification cloneShallow() {
        return (PlatformNotification)cloneShallowContent(new PlatformNotification());
    }
