 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/systemNotification/update/system/cpus/cpu/state/wait"
 * <p>
 * See line 887 in
 ...
 */
public class Wait extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Wait object.
     */
    public Wait() {
        super(OcSys.NAMESPACE, "wait");
    }
     ...
     */
    public Wait clone() {
        return (Wait)cloneContent(new Wait());
    }
     ...
     */
    public Wait cloneShallow() {
        return (Wait)cloneShallowContent(new Wait());
    }
