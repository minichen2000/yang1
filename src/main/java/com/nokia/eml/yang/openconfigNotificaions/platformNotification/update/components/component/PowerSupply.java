...
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.powerSupply.Config;
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.powerSupply.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/platformNotification/update/components/component/power-supply"
 * <p>
 * See line 533 in
 ...
 */
public class PowerSupply extends YangElement {
    ...
    /**
     * Constructor for an empty PowerSupply object.
     */
    public PowerSupply() {
        super(OcPlatform.NAMESPACE, "power-supply");
    }
    ...
    public PowerSupply clone() {
        return (PowerSupply)cloneContent(new PowerSupply());
    }
     ...
     */
    public PowerSupply cloneShallow() {
        return (PowerSupply)cloneShallowContent(new PowerSupply());
    }
