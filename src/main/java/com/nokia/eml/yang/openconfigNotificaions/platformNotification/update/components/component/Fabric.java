...
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.fabric.Config;
import com.nokia.eml.yang.openconfigNotificaions.platformNotification.update.components.component.fabric.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/platformNotification/update/components/component/fabric"
 * <p>
 * See line 565 in
 ...
 */
public class Fabric extends YangElement {
    ...
    /**
     * Constructor for an empty Fabric object.
     */
    public Fabric() {
        super(OcPlatform.NAMESPACE, "fabric");
    }
     ...
     */
    public Fabric clone() {
        return (Fabric)cloneContent(new Fabric());
    }
     ...
     */
    public Fabric cloneShallow() {
        return (Fabric)cloneShallowContent(new Fabric());
    }
