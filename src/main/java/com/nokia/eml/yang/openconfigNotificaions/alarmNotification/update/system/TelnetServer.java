/* 
 * @(#)TelnetServer.java        1.0 15/06/18
 *
...
import com.nokia.eml.yang.openconfigNotificaions.alarmNotification.update.system.telnetServer.Config;
import com.nokia.eml.yang.openconfigNotificaions.alarmNotification.update.system.telnetServer.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/alarmNotification/update/system/telnet-server"
 * <p>
 * See line 207 in
 ...
 */
public class TelnetServer extends YangElement {
    ...
    /**
     * Constructor for an empty TelnetServer object.
     */
    public TelnetServer() {
        super(OcSysTerm.NAMESPACE, "telnet-server");
        setDefaultPrefix();
        setPrefix(OcSysTerm.PREFIX);
    }
     ...
     */
    public TelnetServer clone() {
        return (TelnetServer)cloneContent(new TelnetServer());
    }
     ...
     */
    public TelnetServer cloneShallow() {
        return (TelnetServer)cloneShallowContent(new TelnetServer());
    }
