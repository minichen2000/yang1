 ...
 * generated to "src/com/nokia/eml/yang/openconfigNotificaions/systemNotification/update/system/cpus/cpu/state/nice"
 * <p>
 * See line 872 in
 ...
 */
public class Nice extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty Nice object.
     */
    public Nice() {
        super(OcSys.NAMESPACE, "nice");
    }
     ...
     */
    public Nice clone() {
        return (Nice)cloneContent(new Nice());
    }
     ...
     */
    public Nice cloneShallow() {
        return (Nice)cloneShallowContent(new Nice());
    }
