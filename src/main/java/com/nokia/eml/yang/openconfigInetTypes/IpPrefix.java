 ...
 * the namespace 
 * generated to "src/com/nokia/eml/yang/openconfigInetTypes/ip-prefix"
 * <p>
 * See line 177 in
...
public class IpPrefix extends YangUnion {
    ...
    public IpPrefix(String value) throws YangException {
        super(value,
            new String[] {
                "com.nokia.eml.yang.openconfigInetTypes.Ipv4Prefix",
                "com.nokia.eml.yang.openconfigInetTypes.Ipv6Prefix",
            }
        );
        check();
    }
