...
package com.nokia.eml.yang.openconfigAlarms;
...
/**
 * The root class for namespace http://openconfig.net/yang/alarms (accessible from 
 * OpenconfigAlarms.NAMESPACE) with prefix "oc-alarms" (OpenconfigAlarms.PREFIX).
 *
 * @version 1.0 2018-06-15
 * @author Auto Generated
 */
public class OcAlarms {

    public static final String NAMESPACE = "http://openconfig.net/yang/alarms";
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.nokia.eml.yang.openconfigAlarms");
        OcAlarms.registerSchema();
    }
    ...
    public static void registerSchema() throws JNCException {
        ...
        parser.findAndReadFile("OcAlarms.schema", h, OcAlarms.class);
    }
