 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/transceiver/physicalChannels/channel/state/output-power"
 * <p>
 * See line 77 in
 ...
 */
public class OutputPower extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty OutputPower object.
     */
    public OutputPower() {
        super(OcTransceiver.NAMESPACE, "output-power");
    }
    ...
    public OutputPower clone() {
        return (OutputPower)cloneContent(new OutputPower());
    }
     ...
     */
    public OutputPower cloneShallow() {
        return (OutputPower)cloneShallowContent(new OutputPower());
    }
