/* 
 * @(#)ChromaticDispersion.java        1.0 15/06/18
 *
 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/opticalChannel/state/chromatic-dispersion"
 * <p>
 * See line 909 in
 ...
 */
public class ChromaticDispersion extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty ChromaticDispersion object.
     */
    public ChromaticDispersion() {
        super(OcOptTerm.NAMESPACE, "chromatic-dispersion");
    }
     ...
     */
    public ChromaticDispersion clone() {
        return (ChromaticDispersion)cloneContent(new ChromaticDispersion());
    }
     ...
     */
    public ChromaticDispersion cloneShallow() {
        return (ChromaticDispersion)cloneShallowContent(new ChromaticDispersion());
    }
