...
import com.nokia.eml.yang.openconfigPlatform.components.component.port.BreakoutMode;
import com.nokia.eml.yang.openconfigPlatform.components.component.port.Config;
import com.nokia.eml.yang.openconfigPlatform.components.component.port.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/port"
 * <p>
 * See line 496 in
...
public class Port extends YangElement {
    ...
    /**
     * Field for child container "breakout-mode".
     */
    public BreakoutMode breakoutMode = null;

    /**
     * Constructor for an empty Port object.
     */
    public Port() {
        super(OcPlatform.NAMESPACE, "port");
    }
     ...
     */
    public Port clone() {
        return (Port)cloneContent(new Port());
    }
    ...
    public Port cloneShallow() {
        return (Port)cloneShallowContent(new Port());
    }
    ...
    /* Access methods for container child: "breakout-mode". */

    /**
     * Adds container entry "breakoutMode", using an existing object.
     * @param breakoutMode The object to add.
     * @return The added child.
     */
    public BreakoutMode addBreakoutMode(BreakoutMode breakoutMode)
            throws JNCException {
        this.breakoutMode = breakoutMode;
        insertChild(breakoutMode, childrenNames());
        return breakoutMode;
    }

    /**
     * Adds container entry "breakoutMode".
     * This method is used for creating subtree filters.
     * @return The added child.
     */
    public BreakoutMode addBreakoutMode() throws JNCException {
        BreakoutMode breakoutMode = new BreakoutMode();
        this.breakoutMode = breakoutMode;
        insertChild(breakoutMode, childrenNames());
        return breakoutMode;
    }
    ...
    /**
     * Deletes container entry "breakoutMode".
     * @return An array of the deleted element nodes.
     */
    public NodeSet deleteBreakoutMode() throws JNCException {
        this.breakoutMode = null;
        String path = "breakout-mode";
        return delete(path);
    }
    ...
    public void addChild(Element child) {
        ...
        else if (child instanceof BreakoutMode) breakoutMode = (BreakoutMode)child;
    }
