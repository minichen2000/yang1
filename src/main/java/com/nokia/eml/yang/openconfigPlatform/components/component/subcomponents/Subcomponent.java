/* 
 * @(#)Subcomponent.java        1.0 15/06/18
 *
...
package com.nokia.eml.yang.openconfigPlatform.components.component.subcomponents;

import com.nokia.eml.yang.openconfigPlatform.OcPlatform;
import com.nokia.eml.yang.openconfigPlatform.components.component.subcomponents.subcomponent.Config;
import com.nokia.eml.yang.openconfigPlatform.components.component.subcomponents.subcomponent.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/subcomponents/subcomponent"
 * <p>
 * See line 217 in
 ...
 */
public class Subcomponent extends YangElement {
    ...
    /**
     * Constructor for an empty Subcomponent object.
     */
    public Subcomponent() {
        super(OcPlatform.NAMESPACE, "subcomponent");
    }

    /**
     * Constructor for an initialized Subcomponent object,
     * 
     * @param nameValue Key argument of child.
     */
    public Subcomponent(YangString nameValue) throws JNCException {
        super(OcPlatform.NAMESPACE, "subcomponent");
     ...
     * @param nameValue Key argument of child.
     */
    public Subcomponent(String nameValue) throws JNCException {
        super(OcPlatform.NAMESPACE, "subcomponent");
        Leaf name = new Leaf(OcPlatform.NAMESPACE, "name");
    ...
    public Subcomponent clone() {
        Subcomponent copy;
        try {
            copy = new Subcomponent(getNameValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Subcomponent)cloneContent(copy);
    }
     ...
     */
    public Subcomponent cloneShallow() {
        Subcomponent copy;
        try {
            copy = new Subcomponent(getNameValue().toString());
        } catch (JNCException e) {
        ...
        return (Subcomponent)cloneShallowContent(copy);
    }
