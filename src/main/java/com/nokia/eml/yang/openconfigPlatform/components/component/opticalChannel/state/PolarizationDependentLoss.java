/* 
 * @(#)PolarizationDependentLoss.java        1.0 15/06/18
 *
 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/opticalChannel/state/polarization-dependent-loss"
 * <p>
 * See line 945 in
 ...
 */
public class PolarizationDependentLoss extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty PolarizationDependentLoss object.
     */
    public PolarizationDependentLoss() {
        super(OcOptTerm.NAMESPACE, "polarization-dependent-loss");
    }
     ...
     */
    public PolarizationDependentLoss clone() {
        return (PolarizationDependentLoss)cloneContent(new PolarizationDependentLoss());
    }
     ...
     */
    public PolarizationDependentLoss cloneShallow() {
        return (PolarizationDependentLoss)cloneShallowContent(new PolarizationDependentLoss());
    }
