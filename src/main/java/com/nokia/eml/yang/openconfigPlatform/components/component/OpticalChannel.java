/* 
 * @(#)OpticalChannel.java        1.0 15/06/18
 *
...
import com.nokia.eml.yang.openconfigPlatform.components.component.opticalChannel.Config;
import com.nokia.eml.yang.openconfigPlatform.components.component.opticalChannel.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/optical-channel"
 * <p>
 * See line 962 in
 ...
 */
public class OpticalChannel extends YangElement {
    ...
    /**
     * Constructor for an empty OpticalChannel object.
     */
    public OpticalChannel() {
        super(OcOptTerm.NAMESPACE, "optical-channel");
        setDefaultPrefix();
     ...
     */
    public OpticalChannel clone() {
        return (OpticalChannel)cloneContent(new OpticalChannel());
    }
     ...
     */
    public OpticalChannel cloneShallow() {
        return (OpticalChannel)cloneShallowContent(new OpticalChannel());
    }
