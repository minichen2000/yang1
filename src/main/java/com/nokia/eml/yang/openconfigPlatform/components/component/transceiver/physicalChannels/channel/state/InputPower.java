 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/transceiver/physicalChannels/channel/state/input-power"
 * <p>
 * See line 94 in
 ...
 */
public class InputPower extends YangElement {

    private static final long serialVersionUID = 1L;

    /**
     * Constructor for an empty InputPower object.
     */
    public InputPower() {
        super(OcTransceiver.NAMESPACE, "input-power");
    }
    ...
    public InputPower clone() {
        return (InputPower)cloneContent(new InputPower());
    }
     ...
     */
    public InputPower cloneShallow() {
        return (InputPower)cloneShallowContent(new InputPower());
    }
