/* 
 * @(#)BreakoutMode.java        1.0 15/06/18
 *
...
package com.nokia.eml.yang.openconfigPlatform.components.component.port;

import com.nokia.eml.yang.openconfigPlatform.components.component.port.breakoutMode.Config;
import com.nokia.eml.yang.openconfigPlatform.components.component.port.breakoutMode.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigPlatform/components/component/port/breakout-mode"
 * <p>
 * See line 88 in
 ...
 */
public class BreakoutMode extends YangElement {
    ...
    /**
     * Constructor for an empty BreakoutMode object.
     */
    public BreakoutMode() {
        super(OcPort.NAMESPACE, "breakout-mode");
        setDefaultPrefix();
        setPrefix(OcPort.PREFIX);
    }
     ...
     */
    public BreakoutMode clone() {
        return (BreakoutMode)cloneContent(new BreakoutMode());
    }
     ...
     */
    public BreakoutMode cloneShallow() {
        return (BreakoutMode)cloneShallowContent(new BreakoutMode());
    }
