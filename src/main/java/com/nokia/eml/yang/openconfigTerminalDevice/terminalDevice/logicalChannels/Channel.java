...
package com.nokia.eml.yang.openconfigTerminalDevice.terminalDevice.logicalChannels;

import com.nokia.eml.yang.openconfigTerminalDevice.OcOptTerm;
import com.nokia.eml.yang.openconfigTerminalDevice.terminalDevice.logicalChannels.channel.Config;
import com.nokia.eml.yang.openconfigTerminalDevice.terminalDevice.logicalChannels.channel.Ethernet;
import com.nokia.eml.yang.openconfigTerminalDevice.terminalDevice.logicalChannels.channel.Ingress;
import com.nokia.eml.yang.openconfigTerminalDevice.terminalDevice.logicalChannels.channel.LogicalChannelAssignments;
import com.nokia.eml.yang.openconfigTerminalDevice.terminalDevice.logicalChannels.channel.Otn;
import com.nokia.eml.yang.openconfigTerminalDevice.terminalDevice.logicalChannels.channel.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigTerminalDevice/terminalDevice/logicalChannels/channel"
 * <p>
 * See line 793 in
...
public class Channel extends YangElement {
     ...
     */
    public Channel(YangUInt32 indexValue) throws JNCException {
        super(OcOptTerm.NAMESPACE, "channel");
     ...
     * @param indexValue Key argument of child.
     */
    public Channel(long indexValue) throws JNCException {
        super(OcOptTerm.NAMESPACE, "channel");
        Leaf index = new Leaf(OcOptTerm.NAMESPACE, "index");
        index.setValue(new YangUInt32(indexValue));
        insertChild(index, childrenNames());
