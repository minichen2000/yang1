...
package com.nokia.eml.yang.openconfigLldp;
...
/**
 * The root class for namespace http://openconfig.net/yang/lldp (accessible from 
 * OpenconfigLldp.NAMESPACE) with prefix "oc-lldp" (OpenconfigLldp.PREFIX).
 *
...
public class OcLldp {
    ...
    public static final String NAMESPACE = "http://openconfig.net/yang/lldp";
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.nokia.eml.yang.openconfigLldp");
        OcLldp.registerSchema();
    }
    ...
    public static void registerSchema() throws JNCException {
        ...
        parser.findAndReadFile("OcLldp.schema", h, OcLldp.class);
    }
