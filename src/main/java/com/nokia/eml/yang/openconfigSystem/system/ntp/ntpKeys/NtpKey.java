...
package com.nokia.eml.yang.openconfigSystem.system.ntp.ntpKeys;

import com.nokia.eml.yang.openconfigSystem.OcSys;
import com.nokia.eml.yang.openconfigSystem.system.ntp.ntpKeys.ntpKey.Config;
import com.nokia.eml.yang.openconfigSystem.system.ntp.ntpKeys.ntpKey.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigSystem/system/ntp/ntpKeys/ntp-key"
 * <p>
 * See line 673 in
...
public class NtpKey extends YangElement {
    ...
    /**
     * Constructor for an initialized NtpKey object,
     * 
     * @param keyIdValue Key argument of child.
     */
    public NtpKey(YangUInt16 keyIdValue) throws JNCException {
        super(OcSys.NAMESPACE, "ntp-key");
        Leaf keyId = new Leaf(OcSys.NAMESPACE, "key-id");
        keyId.setValue(keyIdValue);
        insertChild(keyId, childrenNames());
    }
     ...
     * @param keyIdValue Key argument of child.
     */
    public NtpKey(String keyIdValue) throws JNCException {
        super(OcSys.NAMESPACE, "ntp-key");
        Leaf keyId = new Leaf(OcSys.NAMESPACE, "key-id");
        keyId.setValue(new YangUInt16(keyIdValue));
        insertChild(keyId, childrenNames());
    }
     ...
     * @param keyIdValue Key argument of child.
     */
    public NtpKey(int keyIdValue) throws JNCException {
        super(OcSys.NAMESPACE, "ntp-key");
        Leaf keyId = new Leaf(OcSys.NAMESPACE, "key-id");
        keyId.setValue(new YangUInt16(keyIdValue));
        insertChild(keyId, childrenNames());
    ...
    public NtpKey clone() {
        NtpKey copy;
        try {
            copy = new NtpKey(getKeyIdValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (NtpKey)cloneContent(copy);
    }
    ...
    public NtpKey cloneShallow() {
        ...
        return (NtpKey)cloneShallowContent(copy);
    }
