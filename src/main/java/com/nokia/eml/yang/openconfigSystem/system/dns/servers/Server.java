...
package com.nokia.eml.yang.openconfigSystem.system.dns.servers;

import com.nokia.eml.yang.openconfigInetTypes.IpAddress;
import com.nokia.eml.yang.openconfigSystem.OcSys;
import com.nokia.eml.yang.openconfigSystem.system.dns.servers.server.Config;
import com.nokia.eml.yang.openconfigSystem.system.dns.servers.server.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigSystem/system/dns/servers/server"
 * <p>
 * See line 367 in
...
public class Server extends YangElement {
    ...
    /**
     * Constructor for an initialized Server object,
     * 
     * @param addressValue Key argument of child.
     */
    public Server(IpAddress addressValue) throws JNCException {
        super(OcSys.NAMESPACE, "server");
        Leaf address = new Leaf(OcSys.NAMESPACE, "address");
        address.setValue(addressValue);
        insertChild(address, childrenNames());
    }
     ...
     * @param addressValue Key argument of child.
     */
    public Server(String addressValue) throws JNCException {
        super(OcSys.NAMESPACE, "server");
        Leaf address = new Leaf(OcSys.NAMESPACE, "address");
        address.setValue(new IpAddress(addressValue));
        insertChild(address, childrenNames());
    }
    ...
    public Server clone() {
        Server copy;
        try {
            copy = new Server(getAddressValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (Server)cloneContent(copy);
    }
    ...
    public Server cloneShallow() {
        ...
        return (Server)cloneShallowContent(copy);
    }
