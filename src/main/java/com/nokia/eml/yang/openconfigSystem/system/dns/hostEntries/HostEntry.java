...
package com.nokia.eml.yang.openconfigSystem.system.dns.hostEntries;

import com.nokia.eml.yang.openconfigSystem.OcSys;
import com.nokia.eml.yang.openconfigSystem.system.dns.hostEntries.hostEntry.Config;
import com.nokia.eml.yang.openconfigSystem.system.dns.hostEntries.hostEntry.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigSystem/system/dns/hostEntries/host-entry"
 * <p>
 * See line 319 in
...
public class HostEntry extends YangElement {
    ...
    /**
     * Constructor for an initialized HostEntry object,
     * 
     * @param hostnameValue Key argument of child.
     */
    public HostEntry(YangString hostnameValue) throws JNCException {
        super(OcSys.NAMESPACE, "host-entry");
        Leaf hostname = new Leaf(OcSys.NAMESPACE, "hostname");
        hostname.setValue(hostnameValue);
        insertChild(hostname, childrenNames());
    }
     ...
     * @param hostnameValue Key argument of child.
     */
    public HostEntry(String hostnameValue) throws JNCException {
        super(OcSys.NAMESPACE, "host-entry");
        Leaf hostname = new Leaf(OcSys.NAMESPACE, "hostname");
        hostname.setValue(new YangString(hostnameValue));
        insertChild(hostname, childrenNames());
    }
    ...
    public HostEntry clone() {
        HostEntry copy;
        try {
            copy = new HostEntry(getHostnameValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (HostEntry)cloneContent(copy);
    }
    ...
    public HostEntry cloneShallow() {
        ...
        return (HostEntry)cloneShallowContent(copy);
    }
