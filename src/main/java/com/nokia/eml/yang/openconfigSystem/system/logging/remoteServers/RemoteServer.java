...
package com.nokia.eml.yang.openconfigSystem.system.logging.remoteServers;

import com.nokia.eml.yang.openconfigInetTypes.Host;
import com.nokia.eml.yang.openconfigSystem.system.logging.remoteServers.remoteServer.Config;
import com.nokia.eml.yang.openconfigSystem.system.logging.remoteServers.remoteServer.Selectors;
import com.nokia.eml.yang.openconfigSystem.system.logging.remoteServers.remoteServer.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigSystem/system/logging/remoteServers/remote-server"
 * <p>
 * See line 442 in
...
public class RemoteServer extends YangElement {
    ...
    /**
     * Constructor for an initialized RemoteServer object,
     * 
     * @param hostValue Key argument of child.
     */
    public RemoteServer(Host hostValue) throws JNCException {
        super(OcLog.NAMESPACE, "remote-server");
        Leaf host = new Leaf(OcLog.NAMESPACE, "host");
     ...
     * @param hostValue Key argument of child.
     */
    public RemoteServer(String hostValue) throws JNCException {
        super(OcLog.NAMESPACE, "remote-server");
        Leaf host = new Leaf(OcLog.NAMESPACE, "host");
        host.setValue(new Host(hostValue));
        insertChild(host, childrenNames());
    }
    ...
    public RemoteServer clone() {
        RemoteServer copy;
        try {
            copy = new RemoteServer(getHostValue().toString());
        } catch (JNCException e) {
            copy = null;
        }
        return (RemoteServer)cloneContent(copy);
    }
    ...
    public RemoteServer cloneShallow() {
        ...
        return (RemoteServer)cloneShallowContent(copy);
    }
