...
package com.nokia.eml.yang.openconfigSystem.system.ntp.servers;

import com.nokia.eml.yang.openconfigInetTypes.Host;
import com.nokia.eml.yang.openconfigSystem.OcSys;
import com.nokia.eml.yang.openconfigSystem.system.ntp.servers.server.Config;
import com.nokia.eml.yang.openconfigSystem.system.ntp.servers.server.State;
 ...
 * generated to "src/com/nokia/eml/yang/openconfigSystem/system/ntp/servers/server"
 * <p>
 * See line 594 in
...
public class Server extends YangElement {
     ...
     */
    public Server(Host addressValue) throws JNCException {
        super(OcSys.NAMESPACE, "server");
    ...
    public Server(String addressValue) throws JNCException {
        super(OcSys.NAMESPACE, "server");
        Leaf address = new Leaf(OcSys.NAMESPACE, "address");
        address.setValue(new Host(addressValue));
        insertChild(address, childrenNames());
    }
