...
/**
 * The root class for namespace http://openconfig.net/yang/types/yang (accessible from 
 * OpenconfigYangTypes.NAMESPACE) with prefix "oc-yang" (OpenconfigYangTypes.PREFIX).
 *
...
public class OcYang {
    ...
    public static final String NAMESPACE = "http://openconfig.net/yang/types/yang";
    ...
    public static void enable() throws JNCException {
        YangElement.setPackage(NAMESPACE, "com.nokia.eml.yang.openconfigYangTypes");
        OcYang.registerSchema();
    }
    ...
    public static void registerSchema() throws JNCException {
        ...
        parser.findAndReadFile("OcYang.schema", h, OcYang.class);
    }
